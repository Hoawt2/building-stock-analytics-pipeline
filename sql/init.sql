...
CREATE TABLE IF NOT EXISTS dwh.fact_cash_flow (
    ...
    operating_cashflow                  DECIMAL(20, 4),
    payments_for_operating_activities   DECIMAL(20, 4),
    proceeds_from_operating_activities  DECIMAL(20, 4),
    change_in_operating_liabilities     DECIMAL(20, 4),
    change_in_operating_assets          DECIMAL(20, 4),
    depreciation_depletion_and_amortization DECIMAL(20, 4),
    change_in_receivables               DECIMAL(20, 4),
    change_in_inventory                 DECIMAL(20, 4),
    capital_expenditures                DECIMAL(20, 4),
    cashflow_from_investment            DECIMAL(20, 4),
    cashflow_from_financing             DECIMAL(20, 4),
    proceeds_from_repayments_of_short_term_debt DECIMAL(20, 4),
    payments_for_repurchase_of_common_stock DECIMAL(20, 4),
    payments_for_repurchase_of_equity   DECIMAL(20, 4),
    payments_for_repurchase_of_preferred_stock DECIMAL(20, 4),
    dividend_payout                     DECIMAL(20, 4),
    dividend_payout_common_stock        DECIMAL(20, 4),
    dividend_payout_preferred_stock     DECIMAL(20, 4),
    proceeds_from_issuance_of_common_stock DECIMAL(20, 4),
    proceeds_from_issuance_of_long_term DECIMAL(20, 4),
    proceeds_from_issuance_of_preferred_stock DECIMAL(20, 4),
    proceeds_from_repurchase_of_equity  DECIMAL(20, 4),
    proceeds_from_sale_of_treasury_stock DECIMAL(20, 4),
    change_in_cash_and_cash_equivalents DECIMAL(20, 4),
    change_in_exchange_rate             DECIMAL(20, 4),
...
CREATE TABLE IF NOT EXISTS dwh.fact_balance_sheet (
    ...
    cash_and_cash_equivalents_at_carrying_value DECIMAL(20, 4),
    cash_and_short_term_investments     DECIMAL(20, 4),
    inventory                           DECIMAL(20, 4),
    current_net_receivables             DECIMAL(20, 4),
    total_non_current_assets            DECIMAL(20, 4),
    property_plant_equipment            DECIMAL(20, 4),
    accumulated_depreciation_amortization_ppe DECIMAL(20, 4),
    intangible_assets                   DECIMAL(20, 4),
    intangible_assets_excluding_goodwill DECIMAL(20, 4),
    goodwill                            DECIMAL(20, 4),
    investments                         DECIMAL(20, 4),
    long_term_investments               DECIMAL(20, 4),
    short_term_investments              DECIMAL(20, 4),
    other_current_assets                DECIMAL(20, 4),
    other_non_current_assets            DECIMAL(20, 4),
    -- Nợ phải trả (Liabilities)
    total_liabilities                   DECIMAL(20, 4),
    total_current_liabilities           DECIMAL(20, 4),
    current_accounts_payable            DECIMAL(20, 4),
    deferred_revenue                    DECIMAL(20, 4),
    current_debt                        DECIMAL(20, 4),
    ...
    current_long_term_debt              DECIMAL(20, 4),
    long_term_debt_noncurrent           DECIMAL(20, 4),
    short_long_term_debt_total          DECIMAL(20, 4),
    other_current_liabilities           DECIMAL(20, 4),
    other_non_current_liabilities       DECIMAL(20, 4),
    -- Vốn chủ sở hữu (Equity)
    total_shareholder_equity            DECIMAL(20, 4),
    treasury_stock                      DECIMAL(20, 4),
    retained_earnings                   DECIMAL(20, 4),
    common_stock                        DECIMAL(20, 4),
    common_stock_shares_outstanding     DECIMAL(20, 4),
    -- 5. AUDIT COLUMN
    dw_load_timestamp    TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    -- 6. CONSTRAINTS
...
CREATE TABLE IF NOT EXISTS dwh.fact_income_statement (
    ...
    cost_of_goods_and_services_sold     DECIMAL(20, 4),
    -- Chi phí hoạt động
    operating_income                    DECIMAL(20, 4),
    selling_general_and_administrative  DECIMAL(20, 4),
    research_and_development            DECIMAL(20, 4),
    operating_expenses                  DECIMAL(20, 4),
    -- Thu nhập và chi phí khác
    investment_income_net               DECIMAL(20, 4),
    net_interest_income                 DECIMAL(20, 4),
    interest_income                     DECIMAL(20, 4),
    interest_expense                    DECIMAL(20, 4),
    non_interest_income                 DECIMAL(20, 4),
    other_non_operating_income          DECIMAL(20, 4),
    depreciation                        DECIMAL(20, 4),
    depreciation_and_amortization       DECIMAL(20, 4),
    -- Thu nhập trước và sau thuế
    income_before_tax                   DECIMAL(20, 4),
    income_tax_expense                  DECIMAL(20, 4),
    interest_and_debt_expense           DECIMAL(20, 4),
    net_income_from_continuing_operations DECIMAL(20, 4),
    comprehensive_income_net_of_tax     DECIMAL(20, 4),
...
CREATE TABLE IF NOT EXISTS dwh.fact_market_cap (
    ...
    market_cap           DECIMAL(20, 4),         -- Chuyển BIGINT sang DECIMAL để xử lý số lớn và cho phép tính toán chính xác hơn
    dw_load_timestamp    TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
