...
def fetch_cashflow_data(mode='daily'):
    ...
    print(f"Bắt đầu fetch dữ liệu Cashflow cho: {tickers}")
    ...
    for symbol in tickers:
        ...
        annual_df = transform_cashflow_data(raw_data.get("annual", []), symbol, "annual")
        quarterly_df = transform_cashflow_data(raw_data.get("quarterly", []), symbol, "quarterly")
